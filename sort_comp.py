...
sorting_algorithms_names = [f.__name__ for f in sorting_algorithms_funcions]
...
if args.basic:  # Run with -b
    ...
    # pl.axis([0,4.5,0,0.4])
    PlotCompBar(result, sorting_algorithms_names,
                fnames(seq_generators), 'Sequence Length: ' + str(N))
